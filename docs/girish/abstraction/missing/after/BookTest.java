...
class BookTest {
	...
	void testConvert10to13() {
		...
		assertEquals("9780306406157", b.getIsbn().isbn13().toString());

		b = new Book("0596007124", "", "");
		assertEquals("9780596007126", b.getIsbn().isbn13().toString());
		
		b = new Book("1491950358", "", "");
		assertEquals("9781491950357", b.getIsbn().isbn13().toString());
	}
	...
	void testConvert13to10() {
		...
		assertEquals("0306406152", b.getIsbn().isbn10().toString());

		b = new Book("9780596007126", "", "");
		assertEquals("0596007124", b.getIsbn().isbn10().toString());
		
		b = new Book("9781491950357", "", "");
		assertEquals("1491950358", b.getIsbn().isbn10().toString());
	}
}
