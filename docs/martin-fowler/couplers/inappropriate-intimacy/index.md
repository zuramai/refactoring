...
Pada constructor di <github-url to="before/Product.java">Product.java</github-url>, class Product mengetahui ada fungsi `addTag` di Catalog dan menambahkan tag-nya sendiri ke Catalog.
